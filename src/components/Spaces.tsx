  ...
  return (
    <div className="relative bg-gray-900 text-white h-[500px] w-[500px] overflow-y-hidden rounded-lg flex flex-col">
          ...
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path
                ...
                strokeWidth={2}
                d="M4 8V4m0 0h4M4 4l5 5m11-1V4m0 0h-4m4 0l-5 5M4 16v4m0 0h4m0 0l5-5m11 5l-5-5m5 5v-4m0 4h-4"
              />
            </svg>
          </button>
        </div>
      ...
      <div className="flex flex-1 overflow-hidden">
        {/* 工作空间列表 */}
        <div
          className={`transition-all duration-300 overflow-y-auto ${selectedSpaceId ? 'w-1/2 border-r border-gray-700' : 'w-full'}`}
        >
          {loading ? (
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="text-xs text-gray-500 mt-1">{space.groups.length} groups</div>
                    </div>
